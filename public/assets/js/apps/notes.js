$(function () {
    ...
    function getNoteHTML(title, content, date) {
        return (
    ...
    function loadNotes() {
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log("Notes successfully loaded:", response);
                response.forEach(function (note) {
                    ...
                    $html = getNoteHTML(note.title, note.content, today);
    ...
    $("#btn-n-add").on("click", function (event) {
        ...
        $html = getNoteHTML($_noteTitle, $_noteDescription, today);
